...
\subsubsection {Activity Diagram for the User Login Use Case}
 	\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/User Module/login_activity_diagram.png}
...
\subsubsection {Sequence Diagram for the User Register Use Case}
 	\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/User Module/register_sequence_diagram.png}
...
\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/Notification Module/Notification-StateDiagram.png}
...
\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/Notification Module/Notification-UseCaseDiagram.png}
...
\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/Points of Interest Module/POIClassDiagram.png}
...
\subsubsection {Activity Diagram for the Points of Interest Module Use Case}
 	\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/Points of Interest Module/POI_Activity_Diagram.png}
...
\subsubsection {Sequence Diagram for the Points of Interest Use Case}
 	\begin{figure}[H]
   	\centering
   	\includegraphics[width=0.7\textwidth]{Images/Diagrams/Points of Interest Module/POISequenceDiagram.png}
